...
```
git clone https://github.com/SIGMACHAIN-DEV/Rysen.git
...
## Linux
1. Move to the directory where the rysend file is located, execute the node program with the following command
   > ./rysend
...
```
      ...
      unlocked >>> import_key 5JmUNt56fzpikzpjmfnES7e7fbe9tzHXeyn9wD4xqUxvgsFADBz
```
...
```
      ...
      unlocked >>> transfer test001 test002 "100.00000000 RSN" "" true
```
