...
namespace sigmaengine { namespace dapp_history {
   ...
   typedef multi_index_container<
      ...
      indexed_by<
         ...
         >,
         ordered_unique< tag< by_token_symbol >,
            composite_key< dapp_history_object,
               member< dapp_history_object, asset_symbol_type, &dapp_history_object::token_symbol>,
               member< dapp_history_object, uint32_t, &dapp_history_object::symbol_seq>
            >,
            composite_key_compare< std::less< asset_symbol_type >, std::greater< uint32_t > >
         >
      >,
...
FC_REFLECT( sigmaengine::dapp_history::dapp_history_object, (id)(dapp_name)(sequence)(all_sequence)(symbol_seq)(token_symbol)(op) )
