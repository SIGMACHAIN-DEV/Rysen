...
namespace sigmaengine { namespace dapp {
   ...
   class dapp_api 
   {
      public:
         ...
         uint64_t get_nsta602_count()const;
         map< uint32_t, dapp_nsta602_api_object > get_nsta602_list( uint64_t from, uint32_t limit )const;
      private:
