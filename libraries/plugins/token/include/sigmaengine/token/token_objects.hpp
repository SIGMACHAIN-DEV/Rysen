...
namespace sigmaengine { namespace token {
   ...
   enum token_by_key_object_type
   {
      ...
      token_approve_object_type = ( TOKEN_SPACE_ID << 8 ) + 6,
      token_dapp_balance_object_type = ( TOKEN_SPACE_ID << 8 ) + 7,
   };
   ...
   class token_dapp_balance_object : public object< token_dapp_balance_object_type, token_dapp_balance_object > 
   {
      public:
         template< typename Constructor, typename Allocator >
         token_dapp_balance_object( Constructor&& c, allocator< Allocator > a )
         {
            c( *this );
         }
   ...
   typedef oid< token_dapp_balance_object > token_dapp_balance_id_type;
   ...
   class token_approve_object : public object <token_approve_object_type, token_approve_object>
   {
      token_approve_object() = delete;

      public:
         template< typename Constructor, typename Allocator >
         token_approve_object( Constructor&& c, allocator< Allocator > a )
         {
            c( *this );
         }
   ...
   typedef oid< token_approve_object > token_approve_id_type;
   ...
   typedef multi_index_container <
      token_dapp_balance_object,
      indexed_by <
         ordered_unique < 
            tag< by_id >, 
            member< token_dapp_balance_object, token_dapp_balance_id_type, & token_dapp_balance_object::id > 
         >,
         ordered_unique < 
            tag< by_account_and_token >,
            composite_key < 
               token_dapp_balance_object,
               member < token_dapp_balance_object, dapp_name_type, & token_dapp_balance_object::dapp_name >,
               member < token_dapp_balance_object, token_name_type, & token_dapp_balance_object::token >
            >
         >,
         ordered_non_unique <
            tag< by_token >,
         ...
         >
      >,
      allocator < token_dapp_balance_object >
   > token_dapp_balance_index;
   ...
   struct by_dapp_from;
   typedef multi_index_container<
      token_approve_object,
      indexed_by<
         ordered_unique< tag< by_id >, 
            member< token_approve_object, token_approve_id_type, &token_approve_object::id > 
         >,
         ordered_unique< tag< by_dapp_from >,
            composite_key< token_approve_object,
               member< token_approve_object, account_name_type,  &token_approve_object::from >,
               member< token_approve_object, dapp_name_type,  &token_approve_object::dapp_name >,
               member< token_approve_object, token_name_type,  &token_approve_object::token >,
               member< token_approve_object, token_approve_id_type, &token_approve_object::id >
            >
         >,
         ordered_unique< tag< by_from_id >,
            composite_key< token_approve_object,
               ...
               member< token_approve_object, token_approve_id_type, &token_approve_object::id >
            >,
            composite_key_compare< std::less< account_name_type >, std::less< token_approve_id_type > >
         >
      >,
      allocator< token_approve_object >
   > token_approve_index;

} } // namespace sigmaengine::token


FC_REFLECT( sigmaengine::token::token_object, 
            ( id )
            ( name )
            ( symbol )
            ( publisher )
...
CHAINBASE_SET_INDEX_TYPE( sigmaengine::token::token_object, sigmaengine::token::token_index )

FC_REFLECT( sigmaengine::token::token_balance_object, 
            ( id )
            ( account )
            ( token )
            ( balance )
...
CHAINBASE_SET_INDEX_TYPE( sigmaengine::token::token_balance_object, sigmaengine::token::token_balance_index )

FC_REFLECT( sigmaengine::token::token_dapp_balance_object, 
            ( id )
            ( dapp_name )
            ( token )
            ( balance )
)
CHAINBASE_SET_INDEX_TYPE( sigmaengine::token::token_dapp_balance_object, sigmaengine::token::token_dapp_balance_index )

FC_REFLECT( sigmaengine::token::token_fund_object, 
            ( id )
            ( token )
            ( fund_name )
            ( balance )
...
CHAINBASE_SET_INDEX_TYPE( sigmaengine::token::token_fund_object, sigmaengine::token::token_fund_index )

FC_REFLECT( sigmaengine::token::token_staking_interest_object, 
            ( id )
            ( token )
            ( month )
...
CHAINBASE_SET_INDEX_TYPE( sigmaengine::token::token_staking_interest_object, sigmaengine::token::token_staking_interest_index )

FC_REFLECT( sigmaengine::token::token_fund_withdraw_object, 
            ( id )
            ( from )
            ( token )
            ( fund_name )
...
CHAINBASE_SET_INDEX_TYPE( sigmaengine::token::token_fund_withdraw_object, sigmaengine::token::token_fund_withdraw_index )

FC_REFLECT( sigmaengine::token::token_savings_withdraw_object, 
            ( id )
            ( from )
            ( to )
            ( token )
...
CHAINBASE_SET_INDEX_TYPE( sigmaengine::token::token_savings_withdraw_object, sigmaengine::token::token_savings_withdraw_index )

FC_REFLECT( sigmaengine::token::token_approve_object, 
            ( id )
            ( from )
            ( dapp_name )
            ( token )
...
CHAINBASE_SET_INDEX_TYPE( sigmaengine::token::token_approve_object, sigmaengine::token::token_approve_index )