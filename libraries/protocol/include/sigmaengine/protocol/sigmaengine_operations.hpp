...
namespace sigmaengine { namespace protocol {
    ...
    * @ingroup operations
    *
    * @brief Transfers RSN from one account to another.
    */
    ...
    *  contention.  The network will pick the top 23 bobservers for
    *  producing blocks.
    */
   ...
   struct modify_transfer_savings_operation : public base_operation
   {
      account_name_type root;
      account_name_type from;
      account_name_type to;
   ...
   struct balance_savings_operation : public base_operation
   {
      account_name_type root;
      account_name_type to;
      uint32_t          request_id = 0;
...
FC_REFLECT( sigmaengine::protocol::modify_transfer_savings_operation, (root)(from)(to)(request_id)(complete) )
FC_REFLECT( sigmaengine::protocol::balance_savings_operation, (root)(to)(request_id)(amount)(split_pay_order)(split_pay_month)(memo)(complete) )
